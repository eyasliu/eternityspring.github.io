  ...
  <div class="main-container" v-show="$parent.loading" style="display: none;">
    <div class="useful-link no-print">
      ...
      <a class="github-button" href="https://github.com/eyasliu/resume" title="查看源码">
        <img src="/resume/static/images/star.svg" alt="Github"><span>Star</span>
      </a>
    </div>
        ...
        <header class="header">
          <div class="header-box">
            <div class="avatar wow inShow no-print">
              <img src="/resume/static/images/logo.jpg" alt="logo" class="img-responsive">
            </div>
...
<script>
  export default {
    ...
    created(){
      var self = this;
      this.$http.get('/resume/static/resume.json').then((res) =>{
